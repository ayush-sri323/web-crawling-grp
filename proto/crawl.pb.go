...
type NoParram struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *NoParram) Reset() {
	*x = NoParram{}
	if protoimpl.UnsafeEnabled {
...
func (x *NoParram) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NoParram) ProtoMessage() {}

func (x *NoParram) ProtoReflect() protoreflect.Message {
	mi := &file_crawl_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NoParram.ProtoReflect.Descriptor instead.
func (*NoParram) Descriptor() ([]byte, []int) {
...
var file_crawl_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x63, 0x72, 0x61, 0x77, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x63,
	0x72, 0x61, 0x77, 0x6c, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x1f, 0x0a, 0x0b,
	...
	,
...
var file_crawl_proto_goTypes = []interface{}{
	(*UrlResponse)(nil), // 0: crawl_service.UrlResponse
	(*UrlRequest)(nil),  // 1: crawl_service.UrlRequest
	(*NoParram)(nil),    // 2: crawl_service.NoParram
}
var file_crawl_proto_depIdxs = []int32{
	1, // 0: crawl_service.CrawlerService.Crawl:input_type -> crawl_service.UrlRequest
	0, // 1: crawl_service.CrawlerService.Crawl:output_type -> crawl_service.UrlResponse
